...
deployment_settings.auth.hmac_key = "6b3adee4-bb8c-4e7c-a88d-00eebf724e5e"
...
settings.base.system_name = T("India")
...
# END =========================================================================
settings.modules["resource"] = Storage(
    name_nice=T("Resource Information"),
    module_type=1)
